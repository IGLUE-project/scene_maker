...
SceneMaker.Locales = {
	"en": {
		...
		"i.AddMultimediaURL"				: "Add video or audio URL (HTML5 or YouTube)",
		...
		"i.ImageURL"                        : "URL:",
		"i.Import"                          : "Import",
		"i.ImportText"						: "You can import a scene from a JSON file. If you do so, the current scene will be replaced by the imported one.",
		"i.LockAspectRatio"                 : "Maintain aspect ratio:",
		"i.MSettingsAutoplay"				: "Autoplay.",
		"i.MSettingsControls"				: "Controls.",
		"i.MSettingsPoster"					: "Poster URL:",
		"i.MSettingsLoop"					: "Loop.",
		"i.MSettingsResume"					: "Preserve state when the view is hidden.",
		...
		"i.WrongImportedFile"				: "The file must be a JSON file.",
	...
	"es": {
		...
		"i.ActionParamsLoop"      			: "Reproducción en bucle",
		...
		"i.ActionTypeGoToScreen"            : "Ir a una pantalla",
		...
		"i.AddMultimediaURL"				: "Añadir URL de video o audio (HTML5 o YouTube)",
		...
		"i.ImageURL"                        : "URL:",
		"i.Import"                          : "Importar",
		"i.ImportText"						: "Puedes importar un escenario de un archivo JSON. Si lo haces, el escenario actual será reemplazado por el importado.",
		"i.LockAspectRatio"                 : "Mantener relación de aspecto:",
		"i.MSettingsAutoplay"				: "Inicio de reproducción automático.",
		"i.MSettingsControls" 				: "Mostrar controles.",
		"i.MSettingsPoster"					: "URL del póster:",
		"i.MSettingsLoop"					: "Reproducción en bucle.",
		"i.MSettingsResume"   				: "Preservar el estado al ocultar la vista.",
		...
		"i.SceneCaption"					: "Rótulo del escenario",
		...
		"i.VisibilityVisible"               : "Visible",
		"i.WrongImportedFile"				: "El archivo debe ser un archivo JSON.",
	...
	"sr": {
		...
		"i.ActionParamsLoop"   : "Reprodukcija u petlji",
		...
		"i.AddMultimediaURL" : "Dodaj URL videa ili audio zapisa (HTML5 ili YouTube)",
		...
		"i.ImageURL" : "URL:",
		"i.Import"   : "Uvezi",
		"i.ImportText" : "Možete uvesti scenario iz JSON datoteke. Ako to učinite, trenutni scenario će biti zamenjen uvezenim.",
		"i.LockAspectRatio" : "Održavaj odnos širine i visine (aspect ratio):",
		"i.MSettingsAutoplay" : "Automatski početak reprodukcije.",
		"i.MSettingsControls" : "Prikaži kontrole.",
		"i.MSettingsPoster"	  : "URL postera:",
		"i.MSettingsLoop"     : "Reprodukcija u petlji.",
		"i.MSettingsResume"   : "Sačuvaj stanje pri skrivanju prikaza.",
		...
		"i.WrongImportedFile" : "Datoteka mora biti JSON datoteka.",
